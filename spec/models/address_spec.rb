...
# Unit tests for MaerskClient::Address
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MaerskClient::Address do
  let(:instance) { MaerskClient::Address.new }

  describe 'test an instance of Address' do
    it 'should create an instance of Address' do
      expect(instance).to be_instance_of(MaerskClient::Address)
    end
  end
