...
# Unit tests for MaerskClient::Events
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MaerskClient::Events do
  let(:instance) { MaerskClient::Events.new }

  describe 'test an instance of Events' do
    it 'should create an instance of Events' do
      expect(instance).to be_instance_of(MaerskClient::Events)
    end
  end
