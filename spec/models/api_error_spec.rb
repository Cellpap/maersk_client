...
# Unit tests for MaerskClient::ApiError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MaerskClient::ApiError do
  let(:instance) { MaerskClient::ApiError.new }

  describe 'test an instance of ApiError' do
    it 'should create an instance of ApiError' do
      expect(instance).to be_instance_of(MaerskClient::ApiError)
    end
  end
