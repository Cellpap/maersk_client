  ...
  class Address
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MaerskClient::Address` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MaerskClient::Address`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@address_name.nil? && @address_name.to_s.length > 100
        invalid_properties.push('invalid value for "address_name", the character length must be smaller than or equal to 100.')
      end

      if !@street_name.nil? && @street_name.to_s.length > 100
        invalid_properties.push('invalid value for "street_name", the character length must be smaller than or equal to 100.')
      end
      ...
      if !@city_name.nil? && @city_name.to_s.length > 65
        invalid_properties.push('invalid value for "city_name", the character length must be smaller than or equal to 65.')
      end
    ...
    def valid?
      ...
      return false if !@address_name.nil? && @address_name.to_s.length > 100
      return false if !@street_name.nil? && @street_name.to_s.length > 100
      ...
      return false if !@city_name.nil? && @city_name.to_s.length > 65
    ...
    # @param [Object] address_name Value to be assigned
    def address_name=(address_name)
      if address_name.nil?
        fail ArgumentError, 'address_name cannot be nil'
      end

      if address_name.to_s.length > 100
        fail ArgumentError, 'invalid value for "address_name", the character length must be smaller than or equal to 100.'
      end
    ...
    def street_name=(street_name)
      ...
      if street_name.to_s.length > 100
        fail ArgumentError, 'invalid value for "street_name", the character length must be smaller than or equal to 100.'
      end
    ...
    def city_name=(city_name)
      ...
      if city_name.to_s.length > 65
        fail ArgumentError, 'invalid value for "city_name", the character length must be smaller than or equal to 65.'
      end
    ...
    def hash
      [address_name, street_name, street_number, floor, post_code, city_name, state_region, country].hash
    end
