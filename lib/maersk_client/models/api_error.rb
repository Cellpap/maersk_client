  ...
  class ApiError
    ...
    def self.openapi_types
      {
        ...
        :'sub_errors' => :'Array<ApiValidationError>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MaerskClient::ApiError` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MaerskClient::ApiError`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'debug_message')
        ...
        self.debug_message = nil
      end

      if attributes.key?(:'sub_errors')
        if (value = attributes[:'sub_errors']).is_a?(Array)
          self.sub_errors = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @debug_message.nil?
        invalid_properties.push('invalid value for "debug_message", debug_message cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @debug_message.nil?
      true
    end
    ...
    def hash
      [method, request_uri, status, timestamp, message, debug_message, sub_errors].hash
    end
